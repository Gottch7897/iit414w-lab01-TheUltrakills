...
- `generate_final_report.py`: regenerates the locked model evidence, tables, figures, Markdown report, and PDF.
- `IIT414W_FinalReport_TheUltrakills.md`: report text in Markdown.
- `IIT414W_FinalReport_TheUltrakills.pdf`: generated PDF report.
...
- `Capstone/Final_Report/IIT414W_FinalReport_TheUltrakills.pdf`
- `IIT414W_FinalReport_TheUltrakills.pdf`
